...
function Start(){
	...
	document.getElementById("storyContent").innerHTML = "CEO: Hello everyone, here at " + Noun0 + " studios, we strive to create an excellent film experience for " + Group + " everywhere, but it’s come to my attention that a bunch of " + Animal + " have taken over Studio B, producing the most awful " + NounP0 + " anyone’s laid eyes on. This is ruining our professional and " + Adj0 + " relationships as a brand, and more importantly decreasing our " + Noun1 + " value. To turn this around, we’ve partnered with anti-" + Animal + " inc to produce " + Noun2 + "-style documentaries in the hopes it will do something. Any questions? <br><br><br> Employee1: Yeah, how did a bunch of " + Animal + " even get into the " + Building + "? <br><br><br> CEO: It’s currently unknown, the security " + NounP1 + " somehow had a malfunction of the " + Part + " so we didn’t get any footage, but all we know is, they must have stacked themselves and worn a " + Cloth + " to avoid detection. <br><br><br> Employee2: So how do these " + Noun2 + "-style documentaries help our case? <br><br><br> CEO: Glad you asked. These new " + Film + " are capable of 4" + Letter + " resolution, which will be a great selling point on the back of the " + Noun4 + ", so I’d say we just wing it. As our " + Adj1 + " motto goes: We always wing it, when the " + Noun5 + " hits the " + Noun6 + ". <br><br><br> Employee1: Will making these documentaries take long? I’ve got to go to my " + Activity + " at " + Future + " <img src='" + imagePath + "'><br><br><br> CEO: Oh yeah, I’ve " + Verb + " the math, and it should only take about " + Numb + " hours."
